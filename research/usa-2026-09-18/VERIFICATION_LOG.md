...
**Headline counts:** 15 verified open federal solicitations (SAM.gov) · 10 open subcontracts (SBA SubNet) · 40 recently awarded contracts (usaspending.gov API) · 12 upcoming forecast programs (DHS APFS) · 2 open K-12 school-district IT-hardware bids · 16 verified state-level education construction/facilities bids (10-state sweep). **95 records total.**
...
## 7. State-level education project sweep, 2026-09-18 (10 states)

**Scope:** K-12 and higher-education construction/renovation/facilities, education IT hardware, and prime/subcontracting notices tied to school or university projects in California, Texas, Florida, New York, Illinois, Pennsylvania, Ohio, Georgia, North Carolina, and Michigan. Rules: deadline after 2026-09-18, first-party source (state portal, district page, or university procurement portal), aggregator-only records excluded, empty categories stay empty.

**Files:** `~/workspace/research_notes/state-education-sweep-20260918/verified/state-education-bids.json` (16 records) and `~/workspace/research_notes/state-education-sweep-20260918/excluded-20260918.md` (near-misses with URL and reason).

**Result:** 16 verified open bids, all construction/facilities, all deadlines 2026-09-22 through 2026-10-29. FL: UCF ITN2026-01NC mixed-use P3 developer (due 2026-09-23). NY: CUNY Baruch Newman Hall facade restoration + hazmat abatement, M/W/SBE bidders only (due 2026-10-29, CR# 2139108); SUNY Binghamton Student Affairs rehearsal building (due 2026-10-09, CR# 2139119). NC: six UNC System table entries — Appalachian State steam line replacement (due 2026-09-29), NC A&T dorm heating/hot water upgrades (due 2026-09-22), UNC Chapel Hill Bingham Facility HVAC (due 2026-09-24), UNC Chapel Hill parking-deck elevators (due 2026-09-29), UNC Chapel Hill Tate Turner Kuralt fire alarm (due 2026-09-30), UNC Greensboro Spring Garden Apartments HVAC/roofing re-bid (due 2026-10-01). MI: Ionia Public Schools secure entry projects (SIGMA RFP-IONI-260000002559-2, due 2026-09-23 2:00 PM ET); Kent ISD KCTC mechanical improvements (SIGMA RFP-KSD-260000002546-1, due 2026-09-22 2:00 PM ET). CA: LAUSD Bid 2710046 Hollywood HS stair replacement (due 2026-09-29 1:00 PM PDT); LAUSD Bid 2710049 Castelar EEC outdoor classroom (due 2026-09-30 1:00 PM PDT). IL: UIUC Davenport Hall HVAC upgrades U24038 (due 2026-09-23 2:00 PM CT); UIUC North Campus chiller plant cooling tower U25074 (due 2026-10-01 2:00 PM CT). PA: PA DGS / West Chester University Sturzebecker Health Science Center renovations, 4 primes, $53-57M combined (due 2026-10-02 11:00 AM ET).

**Caveats:** NY records show dates only on the NYS Contract Reporter listing; no submission time/timezone. NC records show dates only on the UNC System table; Eastern Time is inferred. MI and CA records are official advertisement documents (SIGMA ad, LAUSD RAMP form) read via lightrfp mirror; SIGMA ref numbers and LAUSD bid numbers are included so each can be located on the official portals, but the portal listing itself was not text-verified. Several deadlines are near-term (Sept 22-24); recheck before use.

**Honest empty categories:** education IT hardware (laptops/Chromebooks/desktops/printers/copiers/classroom tech) — zero verified open bids across all 10 states; every hardware posting found was closed (spring 2026), aggregator-only, or deadline-unconfirmable; districts buy devices through master/cooperative contracts (TX DIR, REMC Save, MEEC), not open bids; fall refresh already happened over summer. Prime/subcontracting notices on official state portals — zero open; only closed notices found. Ohio and Georgia — zero verified records; OH OFCC shows no upcoming solicitations; several portals (OhioBuys, Georgia Procurement Registry, Columbus City Schools Public Purchase, Gwinnett/Fulton Bonfire/Euna, DeKalb IonWave, CalUsource, CaleProcure) require interactive browser navigation or login and could not be text-verified.

**Structural fact:** school and university construction bid tables (UNC System, UIUC Plan Room, PA DGS eMarketplace) are consistently public and deadline-bearing, making construction the most verifiable state-education category; device and subcontracting leads cluster behind login walls or aggregators.
